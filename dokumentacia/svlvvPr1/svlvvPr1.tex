...
po dosadení do \cref{eqn:svlvvpr1-derivv} dostaneme \cref{eqn:svlvvPr1-dosadenie}.
    ...
    \begin{figure}[h!]
        ...
        \caption{PID regulátor na lineairzácii systému v pracovnom bode}
	...
	Aplikujme teraz PID regulátor aj na nelineárny systém, ktorý chceme riadiť. Výsledok zo simulácie je na \cref{fig:svlvPr1VysledokPID}.
		...
		\caption{PID regulátor na nelineaárnom systéme}
		\label{fig:svlvPr1VysledokPID}
	\end{figure}

    Vidíme ako PID regulátor zvláda riadenie pre istú oblasť žiadaných hodnôť, kde sa linearizácia nelineárneho systému nelíši do veľkej miery od pôvodnho sytému.
